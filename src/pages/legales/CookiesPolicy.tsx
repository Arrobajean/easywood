...
const CookiesPolicy = () => {
  ...
  React.useEffect(() => {
    ...
    document.title = "Política de Cookies - LLEMY Reformas";
  }, []);

  const cookieData = [
    {
      category: "Cookies Esenciales (Necesarias)",
      provider: "LLEMY Reformas (propias)",
      purpose:
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none animate-slide-up">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                de la Información y el Comercio Electrónico (LSSI-CE) y el
                Reglamento General de Protección de Datos (RGPD), se facilita la
                siguiente información sobre el uso de cookies en este sitio web:
              </p>
              ...
              <p className="text-muted-foreground mb-6">
                <strong>Denominación social:</strong> AHORRACORP S.L. (LLEMY
                ...
                Madrid - 2 actos en BORME publicados
                <br />
                ...
                <br />
                <strong>Email:</strong> info@llemmy.es
                <br />
                <br />
                El responsable del tratamiento de los datos personales recabados
                a través de las cookies es AHORRACORP S.L., operando bajo el
                nombre comercial LLEMY Reformas y Construcciones. Sus datos
                serán tratados conforme al Reglamento (UE) 2016/679 (RGPD) y la
                Ley Orgánica 3/2018 (LOPDGDD). Puede ejercer sus derechos de
                acceso, rectificación, supresión, oposición, limitación y
                portabilidad enviando una solicitud a la dirección indicada,
                acompañando un documento para su identificación.
              </p>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                que visita guardan en su dispositivo. Son ampliamente utilizadas
                para que los sitios web funcionen, o funcionen de manera más
              ...
              <p className="text-muted-foreground mb-6">
                ...
                configurar sus preferencias en cualquier momento. Si desea
                cambiar su configuración después de haberla aceptado, puede
                hacerlo borrando las cookies de su navegador. La próxima vez que
                visite nuestro sitio, se le volverá a preguntar.
              </p>
              <p className="text-muted-foreground mb-6">
                Además, la mayoría de los navegadores web permiten cierto
                control de la mayoría de las cookies a través de la
                configuración del navegador. Para obtener más información sobre
                las cookies, incluido cómo ver qué cookies se han establecido,
                visite{" "}
                <a
              ...
              <p className="text-muted-foreground mb-6">
                ...
                tratamiento, cuyo responsable es AHORRACORP S.L., operando bajo
                el nombre comercial LLEMY Reformas y Construcciones. Los datos
                se recopilan con la finalidad de gestionar comercial y
                administrativamente la relación que, en su caso, nos une y de
                informarle sobre productos, servicios o eventos de nuestra
                empresa que pudieran ser de su interés, ya sea por medios
                tradicionales o electrónicos. La legitimidad del tratamiento de
                sus datos se basa en la ejecución de un contrato o en su
                consentimiento previo. Los destinatarios de los datos serán
                únicamente otras empresas del mismo grupo, en su caso, u otros
                terceros sobre los que recaiga algún tipo de obligación legal
                para su cesión. Los datos se conservarán durante el periodo en
                que exista una relación contractual y/o comercial establecida, o
                mientras no nos solicite su eliminación. Usted podrá ejercitar
                los derechos de acceso, rectificación, supresión, oposición,
                limitación del tratamiento y portabilidad de sus datos,
                remitiendo una solicitud por escrito a la dirección
              ...
              <p className="text-muted-foreground mb-6">
                ...
                la web y mejorar nuestros servicios. Google puede transferir
                datos fuera del Espacio Económico Europeo, aplicando las
                garantías legales adecuadas, como las cláusulas contractuales
                tipo aprobadas por la Comisión Europea. Además, hemos activado
                la anonimización de IP para minimizar el impacto sobre su
                privacidad. Puede consultar la política de privacidad de Google
                aquí:{" "}
                <a
