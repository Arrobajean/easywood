...
const LegalNotice = () => {
  ...
  React.useEffect(() => {
    ...
    document.title = "Aviso Legal - LLEMY Reformas";
  }, []);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none animate-slide-up">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                www.llemmy.es, del que es titular Llemmy. La navegación por este
                sitio web atribuye la condición de usuario del mismo y implica
              ...
              <p className="text-muted-foreground mb-6">
                ...
                contenidos y servicios que Llemmy ofrece a través de su sitio
                web y con carácter enunciativo pero no limitativo, a no
                emplearlos para:
              </p>
              <ul className="text-muted-foreground mb-6 list-disc ml-6">
                ...
                <li className="mb-2">
                  Provocar daños en los sistemas físicos y lógicos de Llemmy, de
              ...
              <p className="text-muted-foreground mb-6">
                Llemmy no se hace responsable de la información y contenidos
                almacenados, a título enunciativo pero no limitativo, en foros,
                chats, generadores de blogs, comentarios, redes sociales o
                cualquier otro medio que permita a terceros publicar contenidos
                de forma independiente en la página web del prestador.
              </p>
              ...
              <p className="text-muted-foreground mb-6">
                Llemmy es titular de todos los derechos de propiedad intelectual
                e industrial de su página web, así como de los elementos
                contenidos en la misma. Quedan expresamente prohibidas la
