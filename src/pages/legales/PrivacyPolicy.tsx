...
const PrivacyPolicy = () => {
  ...
  React.useEffect(() => {
    ...
    document.title = "Política de Privacidad - LLEMY Reformas";
  }, []);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none animate-slide-up">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                Protección de Datos (RGPD) y la Ley Orgánica 3/2018 de
                Protección de Datos Personales y garantía de los derechos
                digitales (LOPDGDD), se facilita la siguiente información sobre
              ...
              <p className="text-muted-foreground mb-6">
                ...
                AHORRACORP S.L., operando bajo el nombre comercial LLEMY
                Reformas y Construcciones. Sus datos serán tratados conforme al
                Reglamento (UE) 2016/679 (RGPD) y la Ley Orgánica 3/2018
                (LOPDGDD).
              </p>
              ...
              <p className="text-muted-foreground mb-6">
                Los destinatarios de los datos serán únicamente otras empresas
                del mismo grupo, en su caso, u otros terceros sobre los que
                recaiga algún tipo de obligación legal para su cesión.
                <br />
                Asimismo, utilizamos servicios de analítica web proporcionados
                por Google Analytics y Firebase (Google LLC), que pueden
                transferir datos fuera del Espacio Económico Europeo bajo las
                garantías legales adecuadas, como las cláusulas contractuales
                tipo. Hemos activado la anonimización de IP para proteger su
                privacidad. Más información en la política de privacidad de
                Google:{" "}
                <a
              ...
              <p className="text-muted-foreground mb-6">
                ...
                relación contractual y/o comercial establecida, o mientras no
                nos solicite su eliminación.
              </p>
              ...
              <p className="text-muted-foreground mb-6">
                ...
                de sus datos, remitiendo una solicitud por escrito a la
                dirección anteriormente indicada, acompañando un documento para
                su identificación.
              </p>
            </div>
          </div>
