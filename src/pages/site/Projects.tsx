...
const Projects = () => {
  ...
  useEffect(() => {
    document.title = "Llemmy - Proyectos de Reformas Integrales | Madrid";
  }, []);
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Proyectos de reformas en Madrid | LLEMY Reformas</title>
        <meta
          name="description"
          content="Descubre los proyectos de reformas integrales realizados por LLEMY en Madrid. Inspiración, calidad y experiencia a tu servicio."
        />
        <meta
          name="keywords"
          content="proyectos, reformas integrales, Madrid, inspiración, empresa de reformas, casos de éxito"
        />
        <meta
          property="og:title"
          content="Proyectos de reformas en Madrid | LLEMY Reformas"
        />
        <meta
          property="og:description"
          content="Explora nuestros proyectos de reformas en Madrid y encuentra ideas para tu hogar o negocio."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://llemy.com/proyectos" />
        <meta
          property="og:image"
          content="https://llemy.com/images/logo/logo-negro.png"
        />
        <link rel="canonical" href="https://llemy.com/proyectos" />
        <meta name="robots" content="index, follow" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "CollectionPage",
            "name": "Proyectos de reformas en Madrid | LLEMY Reformas",
            "description": "Proyectos de reformas integrales realizados en Madrid por LLEMY Reformas.",
            "url": "https://llemy.com/proyectos",
            "image": "https://llemy.com/images/logo/logo-negro.png"
          }
        `}</script>
      </Helmet>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="text-center mb-16 animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                ...
                Comunidad de Madrid. Cada proyecto refleja la excelencia y
                experiencia de más de 25 años transformando espacios en la
            ...
            <div className="text-center bg-muted/30 rounded-lg p-12 animate-fade-in">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Cada reforma es una historia única. Cuéntanos la tuya y
                crearemos el espacio que siempre has soñado.
              </p>
              <Link to="/contacto">
